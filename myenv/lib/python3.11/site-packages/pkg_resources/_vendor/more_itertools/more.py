...
def substrings_indexes(seq, reverse=False):
    """Yield all substrings and their pos in *seq*
...
def zip_broadcast(*objects, scalar_types=(str, bytes), strict=False):
    ...
    for item in zipper(*iterables):
        ...
        for i, elem in zip(iterable_pos, item):
            new_item[i] = elem

        for i, elem in zip(scalar_pos, scalars):
            new_item[i] = elem
